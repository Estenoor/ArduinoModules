...
void loop() {
 ...
 // theaterChase(strip.Color(127, 127,   0), 50); // Yellow
  ...
  colorWipe(strip.Color(127, 127,   0), 100);  // Red
  colorWipe(strip.Color(  0,   0, 127), 100);  // Green
  colorWipe(strip.Color(200,   0, 255), 100);  // Blue
  colorWipe(strip.Color(127, 127,   0), 50);  // Red
  colorWipe(strip.Color(  0,   0, 127), 50);  // Green
  colorWipe(strip.Color(200,   0, 255), 50);  // Blue
